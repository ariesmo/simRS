...
class Profile extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            ...
            $config['first_url'] = base_url() . 'index.php/profile/index.html?q=' . urlencode($q);
        } else {
            $config['base_url']  = base_url() . 'index.php/profile/index/';
            $config['first_url'] = base_url() . 'index.php/profile/index/';
        }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2019-02-08 10:28:11 */
/* http://harviacode.com */