...
class Sub_periksa_labor extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            ...
            $config['first_url'] = base_url() . 'index.php/sub_periksa_labor/index.html?q=' . urlencode($q);
        } else {
            $config['base_url']  = base_url() . 'index.php/sub_periksa_labor/index/';
            $config['first_url'] = base_url() . 'index.php/sub_periksa_labor/index/';
        }
        ...
        $data['periksa'] = $this->db->get_where('tbl_pemeriksaan_laboratorium', array('kode_periksa' => $kode_periksa))->row_array();
    ...
    {
        $namaPeriksa = $this->db->get_where('tbl_pemeriksaan_laboratorium', array('kode_periksa' => $this->uri->segment(3)))->row_array();
        
        $data = array(
            'button'           => 'Create',
            'action'           => site_url('sub_periksa_labor/create_action'),
    	    'kode_sub_periksa' => set_value('kode_sub_periksa'),
    	    'kode_periksa'     => set_value('kode_periksa', $namaPeriksa['nama_periksa']),
    ...
    function getKodePeriksa($namaPeriksa){
        $this->db->where('nama_periksa', $namaPeriksa);
        $kode = $this->db->get('tbl_pemeriksaan_laboratorium')->row_array();
        return $kode['kode_periksa'];
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2019-02-08 14:55:04 */
/* http://harviacode.com */