...
class Dataobat extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            ...
            $config['first_url'] = base_url() . 'index.php/dataobat/index.html?q=' . urlencode($q);
        } else {
            $config['base_url']  = base_url() . 'index.php/dataobat/index/';
            $config['first_url'] = base_url() . 'index.php/dataobat/index/';
        }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2019-02-06 05:13:23 */
/* http://harviacode.com */