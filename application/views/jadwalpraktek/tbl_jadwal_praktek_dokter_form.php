    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA TBL_JADWAL_PRAKTEK_DOKTER</h3>
            </div>
            <form action="<?php echo $action; ?>" method="post">      
				<table class='table table-bordered'>        
					...
					<tr><td width='200'>Jam Mulai <?php echo form_error('jam_mulai') ?></td>
						<td><input type="text" class="form-control" name="jam_mulai" id="jam_mulai" placeholder="Jam Mulai" value="<?php echo $jam_mulai; ?>" /></td>
					</tr>
					<tr><td width='200'>Jam Selesai <?php echo form_error('jam_selesai') ?></td>
						<td><input type="text" class="form-control" name="jam_selesai" id="jam_selesai" placeholder="Jam Selesai" value="<?php echo $jam_selesai; ?>" /></td>
					</tr>
					<tr>
						<td width='200'>Id Poliklinik <?php echo form_error('id_poliklinik') ?></td>
						<td>
							<?= cmb_dinamis('id_poliklinik', 'tbl_poliklinik', 'nama_poliklinik', 'id_poliklinik', $id_poliklinik);?>
...
<script type="text/javascript">
    $(function() {
        ...
        $("#kode_dokter").autocomplete({
            source: "<?php echo base_url()?>index.php/jadwalpraktek/autocompleteDokter",
            minLength: 1
        });				
    });
</script>
