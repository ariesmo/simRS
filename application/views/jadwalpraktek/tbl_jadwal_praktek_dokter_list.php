            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA TBL_JADWAL_PRAKTEK_DOKTER</h3>
                    </div>
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
                    		...
                    		<?php echo anchor(site_url('jadwalpraktek/word'), '<i class="fa fa-file-word-o" aria-hidden="true"></i> Export Ms Word', 'class="btn btn-primary btn-sm"'); ?>
