                        ...
                        <div class="row" style="margin-bottom: 10px">
                            ...
                            foreach ($pendaftaran_data as $pendaftaran)
                            {
                                ...
                                <tr>
                        			...
                        			<td>
                                    <?php 
                                    if ($pendaftaran->cara_masuk == 'RAWAT JALAN'){
                                        echo $pendaftaran->nama_poliklinik;
                                    } else {
                                        $ranap = $this->db->get_where('tbl_rawat_inap', array('no_rawat' => $pendaftaran->no_rawat))->row_array();
                                        $kodeRanap = $ranap['kode_tempat_tidur'];
                                        $sqlNamaTempatTidur = "SELECT ri.nama_ruangan
                                                                FROM tbl_tempat_tidur as tt, tbl_ruang_rawat_inap as ri
                                                                WHERE tt.kode_ruang_rawat_inap = ri.kode_ruang_rawat_inap and tt.kode_tempat_tidur=$kodeRanap";
                                        $bed = $this->db->query($sqlNamaTempatTidur)->row_array();
