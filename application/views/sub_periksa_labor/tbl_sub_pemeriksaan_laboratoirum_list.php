    ...
    <section class="content">
        <div class="row">
                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                        <table class="table table-bordered" style="margin-bottom: 10px">
                            <tr>
                                <td>Kode Periksa</td>
                                <td><?= $periksa['kode_periksa'];?></td>
                            </tr>
                            <tr>
                                <td>Nama Periksa</td>
                                <td><?= $periksa['nama_periksa'];?></td>
                            </tr>
                            <tr>
                                <td>Biaya</td>
                                <td><?= $periksa['tarif'];?></td>
            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    <div class="box-header">
                        <h3 class="box-title">DATA SUB PEMERIKSAAN LABORATORIUM</h3>
                    </div>
                    <div class="box-body">
                        <div class='row'>
                            <div class='col-md-9'>
                                ...
                                <form action="<?php echo site_url('sub_periksa_labor/index'); ?>" class="form-inline" method="get">
                                    <div class="input-group">
                                        ...
                                        <?php 
                                            ...
                                            {
                                                ?>
                                                <a href="<?php echo site_url('sub_periksa_labor/index/'.$this->uri->segment(3)); ?>" class="btn btn-default">Reset</a>
                                                <?php
                                            }
                                        ?>
