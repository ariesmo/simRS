            ...
            <form action="<?php echo $action; ?>" method="post">   
				<table class='table table-bordered'>  
					<tr>
				    	...
				    	<td><input type="text" class="form-control" name="no_rekamedis" id="no_rekamedis" placeholder="Nomor Rekamedis" value="<?php echo $no_rekamedis; ?>" /></td>
				    </tr>      
				    <tr>
				    ...
				    <tr>
				    	...
				    	<td>
							<?= form_dropdown('jenis_kelamin', array('L' => 'Laki-laki', 'P' => 'Perempuan'), $jenis_kelamin, 'class="form-control"' );?>
				    ...
				    <tr>
				    	...
				    	<td>
							<?= form_dropdown('golongan_darah', array('A' => 'A', 'B' => 'B', 'AB' => 'AB', 'O' => 'O'), $golongan_darah, 'class="form-control"' );?>
				    ...
				    <tr>
				    	<td width='200'>Id Agama <?php echo form_error('id_agama') ?></td>
				    	<td>
							<?= cmb_dinamis('id_agama', 'tbl_agama', 'agama', 'id_agama', $id_agama, 'class="form-control"');?>
				    ...
				    <tr>
				    	...
				    	<td>
							<?= cmb_dinamis('status_menikah', 'tbl_status_menikah', 'status_menikah', 'id_status_menikah', $status_menikah, 'class="form-control"');?>
				    		<!--<input type="text" class="form-control" name="status_menikah" id="status_menikah" placeholder="Status Menikah" value="<?php echo $status_menikah; ?>" />-->
				    	</td>
				    </tr>
				    <tr>
				    ...
				    <tr>
				    	<td width='200'>Id Pekerjaan <?php echo form_error('id_pekerjaan') ?></td>
				    	<td>
							<?= cmb_dinamis('id_pekerjaan', 'tbl_pekerjaan', 'nama_pekerjaan', 'id_pekerjaan', $id_pekerjaan, 'class="form-control"');?>
				    ...
				    <tr>
				    	<td></td>
				    	<td>
				    		<!--<input type="hidden" name="no_rekamedis" value="<?php echo $no_rekamedis; ?>" />-->
