    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA TBL_DOKTER</h3>
            </div>
            <form action="<?php echo $action; ?>" method="post">   
				<table class='table table-bordered'>  
				    ...
				    <tr>
				    	<td width='200'>Id Status Menikah <?php echo form_error('id_status_menikah') ?></td>
				    	<td>
							<?= cmb_dinamis('id_status_menikah', 'tbl_status_menikah', 'status_menikah', 'id_status_menikah', $id_status_menikah, 'class="form-control"');?>
				    		<!--<input type="text" class="form-control" name="id_status_menikah" id="id_status_menikah" placeholder="Id Status Menikah" value="<?php echo $id_status_menikah; ?>" />-->
				    	</td>
				    </tr>
				    <tr>
				    	<td width='200'>Id Spesialis <?php echo form_error('id_spesialis') ?></td>
				    	<td>
							<?= cmb_dinamis('id_spesialis', 'tbl_spesialis', 'spesialis', 'id_spesialis', $id_spesialis, 'class="form-control"');?>
				    ...
				    <tr>
				    	<td></td>
				    	<td><!--<input type="hidden" name="kode_dokter" value="<?php echo $kode_dokter; ?>" />-->
