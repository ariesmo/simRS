            ...
            <div class="box-header with-border">
            	...
            	<form action="<?php echo $action; ?>" method="post">
					<table class='table table-bordered'>  
					    ...
					    <tr>
					    	<td width='200'>Kategori Barang <?php echo form_error('id_kategori_barang') ?></td>
					    	<td>
								<?= cmb_dinamis('id_kategori_barang', 'tbl_kategori_barang', 'nama_kategori', 'id_kategori_barang', $id_kategori_barang,'class = "form-control"');?>
					    ...
					    <tr>
					    	<td width='200'>Id Satuan Barang <?php echo form_error('id_satuan_barang') ?></td>
					    	<td>
								<?= cmb_dinamis('id_satuan_barang', 'tbl_satuan_barang', 'nama_satuan', 'id_satuan', $id_satuan_barang,'class = "form-control"');?>
					    ...
					    <tr>
					    	...
					    	<a href="<?php echo site_url('dataobat') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td>
					    </tr>
					</table>
				</form>        
		</div>
