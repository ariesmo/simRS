                            ...
                            <table class="table table-bordered" style="margin-bottom: 10px">
                                ...
                                foreach ($dataobat_data as $dataobat)
                                {
                                    ...
                                    <tr>
                            			...
                            			<td><?php echo strtoupper($dataobat->nama_barang) ?></td>
                            			<td><?php echo strtoupper($dataobat->nama_kategori) ?></td>
                            			<td><?php echo strtoupper($dataobat->nama_satuan) ?></td>
                            			<td><?php echo $dataobat->harga ?></td>
                            			<td style="text-align:center" width="200px">
                            				<?php 
                            				echo anchor(site_url('dataobat/read/'.$dataobat->kode_barang),'<i class="fa fa-eye" aria-hidden="true"></i>','class="btn btn-danger btn-sm"'); 
                            				echo '  '; 
