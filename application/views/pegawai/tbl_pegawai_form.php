        ...
        <div class="box box-warning box-solid">
            ...
            <form action="<?php echo $action; ?>" method="post">
				<table class='table table-bordered'> 
					<tr>
						<td width='200'>NIK <?php echo form_error('nama_pegawai') ?></td>
					...
					<tr>
					    <td width='200'>Id Jenjang Pendidikan <?php echo form_error('id_jenjang_pendidikan') ?></td>
					    <td>
							<?= cmb_dinamis('id_jenjang_pendidikan', 'tbl_jenjang_pendidikan', 'jenjang_pendidikan', 'id_jenjang_pendidikan', $id_jenjang_pendidikan);?>
					...
					<tr>
						...
						<td>
							<?= cmb_dinamis('id_jabatan', 'tbl_jabatan', 'nama_jabatan', 'id_jabatan', $id_jabatan);?>
					...
					<tr>
						...
						<td>
							<?= cmb_dinamis('kode_jenjang', 'tbl_jenjang', 'nama_jenjang', 'kode_jenjang', $kode_jenjang);?>
					...
					<tr>
						<td width='200'>Id Departemen <?php echo form_error('id_departemen') ?></td>
						<td>
							<?= cmb_dinamis('id_departemen', 'tbl_departemen', 'nama_departemen', 'id_departemen', $id_departemen);?>
					...
					<tr>
						<td width='200'>Id Bidang <?php echo form_error('id_bidang') ?></td>
						<td>
							<?= cmb_dinamis('id_bidang', 'tbl_bidang', 'nama_bidang', 'id_bidang', $id_bidang);?>
							<!--<input type="text" class="form-control" name="id_bidang" id="id_bidang" placeholder="Id Bidang" value="<?php echo $id_bidang; ?>" />-->
						</td>
					</tr>
					<tr>
						<td></td>
						<td><!--<input type="hidden" name="nik" value="<?php echo $nik; ?>" />--> 
